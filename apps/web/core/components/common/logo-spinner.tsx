...
// Replaces the upstream generic-spinner-with-wordmark. The icon does a gentle
// Y-axis flip on a 2.4s loop (paused at the front face for a third of the cycle
// so it reads as deliberate, not jittery). Wordmark uses PRODUCT_NAME_SHORT
// from the brand seam so a future rename touches a single file.
