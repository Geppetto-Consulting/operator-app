...
const DEFAULT_TITLE = "Promptable Operator";
const DEFAULT_DESCRIPTION = "Made with Promptable Operator, an AI-powered work management platform with publishing capabilities.";
