...
// assets
import { BrandLogo } from "@plane/propel/icons";
...
export function PoweredBy(props: TPoweredBy) {
  ...
  return (
    ...
    >
      <BrandLogo className="h-3 w-auto text-primary" />
      <div className="text-11">
        Powered by <span className="font-semibold">Promptable Operator Publish</span>
      </div>
    </a>
  );
}
