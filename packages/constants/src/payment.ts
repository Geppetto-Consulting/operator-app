...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "Promptable Operator Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for Promptable Operator Cloud",
    type: "BUSINESS",
    prices: [
      {
  ...
  [EProductSubscriptionEnum.ENTERPRISE]: {
    ...
    name: "Promptable Operator Enterprise",
    description: "",
    type: "ENTERPRISE",
    prices: [
      {
