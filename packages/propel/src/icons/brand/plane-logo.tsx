...
// [ours: brand] BrandLogo: operator-icon glyph (ENG-248). 244x237 viewBox
// matches infra/landing/assets/operator-icon.svg. Dark rounded-rect background
// + lavender "O" mark — brand-coloured regardless of the `color` prop so the
// glyph stays recognisable on any surface (light, dark, branded).
export function BrandLogo({ width = "44", height = "44", className }: Omit<ISvgIcons, "color"> & { color?: string }) {
  return (
    <svg
      width={width}
      height={height}
